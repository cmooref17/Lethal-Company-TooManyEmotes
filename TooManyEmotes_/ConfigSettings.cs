...
namespace TooManyEmotes.Config
{
    public static class ConfigSettings
    {
        ...
        public static ConfigEntry<bool> enableEmoteAudio;
        public static ConfigEntry<bool> disableEmoteAudioOthers;
        public static ConfigEntry<float> emoteAudioVolumeMultiplier;
        public static ConfigEntry<bool> automaticallyLoadAudio;
        ...
        public static void BindConfigSettings()
        {
            ...
            enableEmoteAudio = AddConfigEntry("Emote Audio", "EnableEmoteAudio", true, "If true, audio will play from emotes with audio associated with them.");
            disableEmoteAudioOthers = AddConfigEntry("Emote Audio", "DisableEmoteAudioOtherPlayers", true, "If true, audio will not play from other players emoting. Only applies if EnableEmoteAudio is enabled.");
            emoteAudioVolumeMultiplier = AddConfigEntry("Emote Audio", "EnableEmoteAudio", 1.0f, "If true, audio will play from emotes with audio associated with them.");
            automaticallyLoadAudio = AddConfigEntry("Emote Audio", "AutomaticallyLoadAudio", true, "If true, emote audio will be automatically pre-loaded and cached as they are unlocked. Pre-loading audio will prevent audio delays when performing emotes for the first time during a session, but will increase memory usage.");

            disableRaritySystem = AddConfigEntry("Emote Settings", "DisableRaritySystem", false, "[Host only] If true, every emote will have the same likelyhood of appearing in the emote store.");
            ...
            disableEmotesForSelf = AddConfigEntry("Emote Radial Menu", "DisableEmotingForSelf", false, "Disabling this will not convert your player's animator controller to an AnimatorOverrideController, and you will not be able to perform custom emotes. Disable this in case of specific mod conflicts. You will still be able to see other players emoting.");
            ...
            toggleRotateCharacterInEmote = AddConfigEntry("Emote Radial Menu", "ToggleRotateCharacterInEmote", false, "If true, rotating character while emoting will be toggled, instead of rotating while holding the hotkey.");
